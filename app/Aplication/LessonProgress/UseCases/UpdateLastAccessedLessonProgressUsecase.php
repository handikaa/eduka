...
class UpdateLastAccessedLessonProgressUsecase
{
    ...
    public function execute(User $student, UpdateLastAccessedLessonProgressDto $dto): LessonProgress
    {
        return DB::transaction(function () use ($student, $dto) {
            if ($student->role !== 'student') {
                throw new OnlyStudentCanUpdateLastAccessedLessonProgressException();
            }
